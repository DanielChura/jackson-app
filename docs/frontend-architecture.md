...
- **✅**: Estructura Frontend (Scaffold completo)
- **-**: No iniciado

## Tabla 1: Storefront (Cliente)

| Vista                | Ruta                | Carpeta de Feature           | Descripción                     | Estado |
| :------------------- | :------------------ | :--------------------------- | :------------------------------ | :----- |
...
| **Mi Cuenta**        | `/account`          | `src/app/features/account`   | Perfil, direcciones, órdenes    | ✅     |
