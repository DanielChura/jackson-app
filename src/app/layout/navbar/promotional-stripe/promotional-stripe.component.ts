...
@Component({
  ...
  standalone: true,
  template: `
    <aside class="bg-gray-50 select-none text-gray-500">
      <div
      ...
      >
        <span class="text-xs font-medium uppercase text-center">
          ¡Síguenos en nuestras redes y participa por una Jackson Dinky JS22!
        </span>

        <div class="hidden sm:flex items-center gap-4 text-xs font-medium  uppercase">
          <a
